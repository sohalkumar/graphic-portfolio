  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 bg-dark-black text-light-green font-galada py-1 sm:py-4 flex items-center justify-between sm:px-[7.5rem] z-[10]">
        <p className="text-[3rem] mx-auto lg:mx-0"><Link href="/">Sonam Chawla</Link></p>
        <div className="hidden lg:flex sm:flex-row items-center font-poppins font-bold text-[1.5rem] gap-[2rem]">
          <Link href="#projects" className="group transition duration-300 scroll-smooth">
            <p>
              Projects
              <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-light-green"></span>
            </p>
          </Link>
          <Link href="#about-me" className="group transition duration-300 scroll-smooth">
            <p>
              About me{" "}
              <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-light-green"></span>{" "}
            </p>
          ...
          <Link
            href="#get-in-touch"
            className="bg-light-green text-dark-black px-[1rem] py-1 rounded-[1.75rem] animate-pulse hover:animate-none hover:duration-300 group transition duration-300 scroll-smooth"
          >
            <p>
              Get in touch
      ...
      <div className="fixed bottom-0 left-0 right-0 sm:text-[1.5rem] flex items-center justify-center gap-8 bg-dark-black font-bold py-3 lg:hidden z-[10]">
        <Link href="#projects">
          <p className="scroll-smooth">Projects</p>
        </Link>
        <Link href="#about-me">
          <p className="scroll-smooth">About me</p>
        </Link>
        <Link
          href="#get-in-touch"
          className="bg-light-green text-dark-black px-[1rem] py-1 rounded-[1.75rem] animate-pulse"
        >
          <p className="scroll-smooth duration-1000">Get in touch</p>
        </Link>
      </div>
    </>
  );
